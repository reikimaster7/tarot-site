...
rev:"無計画な行動や衝動的な判断が目立ちやすい状態です。自由であることと無責任であることの境界が曖昧になっている可能性があります。このまま進むと後悔につながる流れも見えています。今はあえて立ち止まり、本当に進むべき道なのかを見直すことが大切です。"
},
{
name:"魔術師",
img:"images/major_02_magician.png",
up:"あなたの中にある才能や力が表に出始めています。今はアイデアやチャンスに恵まれやすく、行動すれば現実を動かせるタイミングです。自信を持つことで周囲の評価も自然と高まっていくでしょう。小さな一歩でも構いません。行動することで未来は大きく変化していきます。",

rev:"本来持っている力をうまく発揮できていない状態です。自信のなさや迷いが行動を止めてしまっている可能性があります。また、周囲とのコミュニケーションのズレにも注意が必要です。今は焦らず、自分の強みを再確認することが重要です。"
},
{
name:"女教皇",
...
up:"大切な選択のタイミングに来ています。それは人との関係である場合もあれば、自分自身の価値観に関わる決断かもしれません。心が求めるものと現実の間で揺れやすい時ですが、最終的には「自分が本当に望むもの」を選ぶことが重要です。その選択が未来の満足感へとつながっていきます。",

rev:"気持ちのすれ違いや迷いが生じやすい状態です。感情に流されて判断すると後悔する可能性があります。また、選択を先延ばしにしていることが問題を長引かせているかもしれません。一度立ち止まり、自分の本音と向き合うことが必要です。"
},
{
name:"戦車",
...
up:"大きな区切りの時を迎えています。それは終わりであると同時に、新しい始まりでもあります。これまで続いてきた流れが一度リセットされることで、次のステージへ進む準備が整います。恐れを感じるかもしれませんが、この変化は避けるべきものではなく、受け入れることで未来が開けていきます。",

rev:"変化を受け入れられず、過去に執着している状態です。本来終わるべきものを手放せていないため、停滞が続いている可能性があります。このままでは新しい流れが入ってきません。勇気を持って一区切りつけることが、次のチャンスを引き寄せる鍵になります。"
},
{
name:"節制",
...
up:"物事が明るい方向へと進んでいます。これまでの努力が実を結び、自信や喜びを感じられるタイミングです。周囲との関係も良好になりやすく、素直な気持ちがさらに運気を高めてくれます。この流れを信じて前向きに進むことで、大きな成功へとつながるでしょう。",

rev:"良い流れは来ているものの、少しタイミングが遅れている状態です。焦りや不安が視野を狭くしている可能性があります。結果が出ないからといって悲観する必要はありません。今は基盤を整える時期と捉え、前向きな姿勢を保つことが大切です。"
},
{
name:"審判",
